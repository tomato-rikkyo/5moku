...
class GameUI(tk.Frame):
    ...
    def __init__(self, master=None, model=None):
        ...
        # 盤面の大きさを設定
        self.c = tk.Canvas(self, width=540, height=540, highlightthickness=0)
    ...
    def draw_piece(self, index, first_player):
        ...
        y = int(index/9)*60+10
        if first_player:
            self.c.create_oval(x, y, x+40, y+40, width=0.0, fill="#333333")
        else:
            self.c.create_oval(x, y, x+40, y+40, width=0.0, fill="#FFFFFF")
    ...
    def on_draw(self):
        ...
        # 盤面の格子を描画
        self.c.create_rectangle(0,0,540,540,width=0.0,fill="#DEB887")
        for r in range(9):
            self.c.create_line(0,r*60,540,r*60, width=1.0, fill="#333333")
        for c in range(9):
            self.c.create_line(c*60, 0, c*60, 540, width=1.0, fill="#333333")
